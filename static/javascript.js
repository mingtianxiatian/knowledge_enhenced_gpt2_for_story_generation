...
//        var rowCells = allRows[singleRow].split(',');
        ...
        for (var rowCell = 0; rowCell < data.index[singleRow].length; rowCell++) {
            ...
            if (singleRow == 0) {
                ...
                if ((rowCell == lenth-1)&&(singleRow<data.index.length-1))
                {
                    holders_count_total = holders_count_total+parseFloat(data.index[singleRow][rowCell])
                    var ban1 = data.index[singleRow][rowCell]
                    var banl = parseFloat(data.index[singleRow][rowCell])
//                    console.log(typeof(ban1))
//                    console.log(typeof(banl))
                    }
